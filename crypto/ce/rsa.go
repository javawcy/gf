...
func newCERsa(pubKey, priKey []byte) (*cRsa, error) {
	...
	if block == nil {
		return nil, gerror.WrapCodef(gcode.CodeInvalidParameter, errors.New("decode failed"), `cRsa pubKey decode failed`, "")
	}
	...
	if block == nil {
		return nil, gerror.WrapCodef(gcode.CodeInvalidParameter, err, `cRsa priKey decode failed`, "")
	}
	...
	return nil, gerror.WrapCodef(gcode.CodeInvalidParameter, err, `cRsa init failed`, "")
}
